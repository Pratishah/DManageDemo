...
{
    public partial class DManageContext1 : DbContext
    {
        string connString = "";
        public DManageContext1(IConfiguration configuration)
        {
            connString = configuration.GetValue<string>("ConnectionStrings:DBconnection");
        }

        public DManageContext1(DbContextOptions<DManageContext> options)
            : base(options)
        {
        }
